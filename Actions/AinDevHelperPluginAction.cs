...
namespace AinDevHelperPluginLibrary.Actions {
    ...
    public class AinDevHelperPluginAction {
        ...
        //public static IEnumerable<AinDevHelperPluginAction> WebLinkActionsFromStrings(params string[] actionNames) {
        //    List<AinDevHelperPluginAction> pluginActions = new List<AinDevHelperPluginAction>();
        //    if (actionNames == null || actionNames.Length == 0) {
        //        return pluginActions;
        //    }
        ...
        //    foreach (string actionName in actionNames) {
        //        pluginActions.Add(new AinDevHelperPluginWebLinkAction(actionName, actionName));
        //    }
